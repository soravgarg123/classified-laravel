...
<div class="portlet box blue">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="{{ URL::route('admin.class.create') }}" class="btn btn-default btn-sm">
    ...
    <div class="portlet-body ">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ count($value->subClasses) }}</td>
                    <td>{{ $value->description }}</td>
                    <td>{{ $value->created_at }}</td>
                    <td>
                        <a href="{{ URL::route('admin.class.edit', $value->id) }}" class="btn btn-sm btn-info">
                            <span class="glyphicon glyphicon-edit"></span> {{ $langLbl['Edit'] }}
                        </a>
                    </td>
                    <td>
                        <a href="{{ URL::route('admin.class.delete', $value->id) }}" class="btn btn-sm btn-danger" id="js-a-delete">
        ...
        <div class="pull-right">{{ $classes->links() }}</div>
