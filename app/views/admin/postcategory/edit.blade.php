...
<div class="portlet box blue">
    ...
    <div class="portlet-body form">
        <form class="form-horizontal form-bordered form-row-stripped" role="form" method="post" action="{{ URL::route('admin.postcategory.store') }}">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {{ Form::textarea('description'.$rvalue, $category->{'description'.$rvalue}, ['class' => 'form-control']) }}
                    </div>
                </div>	
                @endforeach
                @endif          
            ...
            <div class="form-actions fluid">
                <div class="col-sm-12 text-center">
                    ...
                    <a href="{{ URL::route('admin.postcategory') }}" class="btn btn-primary">
