...
<div class="portlet box blue">
    ...
    <div class="portlet-body form">
        <form class="form-horizontal form-bordered form-row-stripped" role="form" method="post" action="{{ URL::route('admin.post.sub.category.store') }}">
            <div class="form-body">
            ...
            <div class="form-actions fluid">
                <div class="col-sm-12 text-center">
                    ...
                    <a href="{{ URL::route('admin.postcategory.edit', $subCategory->category_id) }}" class="btn btn-primary">
