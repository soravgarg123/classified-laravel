...
<div class="row">
    <div class="col-md-12">
        <h3 class="page-title">{{ $langLbl['Policy'] }} {{ $langLbl['Management'] }}</h3>
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-plus"></i> {{ $langLbl['Add'] }} {{ $langLbl['Policy'] }}
        </div>
    </div>
    ...
    ?>
        <form class="form-horizontal form-bordered form-row-stripped" role="form" method="post" action="{{ URL::route('admin.policy.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea required class="wysihtml5 form-control" name="{{ $key }}" rows="3"></textarea>
                </div>
            </div>
            <div class="form-group">
