...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-navicon"></i> {{ $langLbl['Policy'] }} {{ $langLbl['List'] }}
        </div>
        <?php if(count($policy) < 1) { ?>
        <div class="actions">
            <a href="{{ URL::route('admin.policy.create') }}" class="btn btn-default btn-sm">
             ...
             <?php $currentLang = $_COOKIE['current_lang'];
              ...
              ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ URL::route('admin.policy.edit', $value->id) }}" class="btn btn-sm btn-info">
                            <span class="glyphicon glyphicon-edit"></span> {{ $langLbl['Edit'] }}
                        </a>
                    </td>
                    <td>
                        <a href="{{ URL::route('admin.policy.delete', $value->id) }}" class="btn btn-sm btn-danger" id="js-a-delete">
