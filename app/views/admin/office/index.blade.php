...
<div class="portlet box blue">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="{{ URL::route('admin.office.create') }}" class="btn btn-default btn-sm">
    ...
    <div class="portlet-body ">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ URL::route('admin.office.edit', $value->id) }}" class="btn btn-sm btn-info">
                            <span class="glyphicon glyphicon-edit"></span> {{ $langLbl['Edit'] }}
                        </a>
                    </td>
                    <td>
                        <a href="{{ URL::route('admin.office.delete', $value->id) }}" class="btn btn-sm btn-danger" id="js-a-delete">
        ...
        <div class="pull-right">{{ $officies->links() }}</div>
