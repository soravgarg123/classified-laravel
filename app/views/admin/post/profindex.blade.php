...
<div class="portlet box blue">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="{{ URL::route('admin.profession.create') }}" class="btn btn-default btn-sm">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ URL::route('admin.profession.edit', $value->id) }}" class="btn btn-sm btn-info">
                            <span class="glyphicon glyphicon-edit"></span> {{ $langLbl['Edit'] }}
                        </a>
                    </td>
                    <td>
                        <a href="{{ URL::route('admin.profession.delete', $value->id) }}" class="btn btn-sm btn-danger" id="js-a-delete">
