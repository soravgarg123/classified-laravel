...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-navicon"></i> {{ $langLbl['Terms'] }} {{ $langLbl['List'] }}
        </div>
        <?php if(count($terms) < 1) { ?>
        <div class="actions">
            <a href="{{ URL::route('admin.terms.create') }}" class="btn btn-default btn-sm">
             ...
             <tbody>
                ...
                <tr>
                   ...
                   <td>{{ $value->$column}}</td>
                    ...
                    <td>
                        <a href="{{ URL::route('admin.terms.edit', $value->id) }}" class="btn btn-sm btn-info">
                            <span class="glyphicon glyphicon-edit"></span> {{ $langLbl['Edit'] }}
                        </a>
                    </td>
                    <td>
                        <a href="{{ URL::route('admin.terms.delete', $value->id) }}" class="btn btn-sm btn-danger" id="js-a-delete">
