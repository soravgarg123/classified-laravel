...
class SubCategoryController extends \BaseController {
    ...
    public function create($id) {
        ...
        return View::make('admin.category.sub.create')->with($param)->with('siteLanguage', $this->siteLanguage)->with('langLbl', $this->languageLabels)
    ...
    public function edit($id) {
        ...
        return View::make('admin.category.sub.edit')->with($param)->with('siteLanguage', $this->siteLanguage)->with('langLbl', $this->languageLabels)
                        ->with('currentLanguage', $this->currentLanguage);
    }
    ...
    public function store() {
        ...
        if ($validator->fails()) {
            ...
            foreach ($this->siteLanguage as $value) {
                ...
                $subCategory->$nameCtrl = Input::get($nameCtrl);
                $subCategory->$descCtrl = Input::get($descCtrl);
            }
            ...
            return Redirect::route('admin.category.edit', Input::get('category_id'))->with('alert', $alert);
        }
    }
    ...
    public function delete($id) {
        ...
        return Redirect::route('admin.category.edit', $categoryId)->with('alert', $alert);
    }
