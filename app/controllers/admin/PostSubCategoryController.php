...
class PostSubCategoryController extends \BaseController {
    ...
    public function create($id) {
        ...
        return View::make('admin.postcategory.sub.create')->with($param)->with('siteLanguage', $this->siteLanguage)->with('langLbl', $this->languageLabels)
                        ->with('currentLanguage', $this->currentLanguage);
    }

    public function edit($id) {
        $param['pageNo'] = 14;
        $param['subCategory'] = BlogSubCategoryModel::find($id);
        ...
        return View::make('admin.postcategory.sub.edit')->with($param)->with('siteLanguage', $this->siteLanguage)->with('langLbl', $this->languageLabels)
                        ->with('currentLanguage', $this->currentLanguage);
    }
    ...
    public function store() {
        ...
        if ($validator->fails()) {
            ...
            if (Input::has('sub_category_id')) {
                $id = Input::get('sub_category_id');
                $subCategory = BlogSubCategoryModel::find($id);
            } else {
                $subCategory = new BlogSubCategoryModel;
            }
            $subCategory->category_id = Input::get('category_id');
            $subCategory->name = Input::get('name');
            $subCategory->icon = Input::get('icon');
            ...
            return Redirect::route('admin.postcategory.edit', Input::get('category_id'))->with('alert', $alert);
        }
    }
    ...
    public function delete($id) {
        ...
        return Redirect::route('admin.postcategory.edit', $categoryId)->with('alert', $alert);
    }
